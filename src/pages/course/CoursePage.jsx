...
export default function CoursePage(props) {
    ...
    const date = data.datum_kurzu ? prismicH.asDate(data.datum_kurzu) : null
                ...
                <section className='course__page__info'>
                    ...
                    <div className='info__block'>
                        ...
                        <div>
                            ...
                            <Map center={{ lat: data.presna_lokace_kurzu.latitude, lng: data.presna_lokace_kurzu.longitude }} />
                        </div>
                    </div>
